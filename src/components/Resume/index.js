        ...
        <ol class="relative border-l  border-gray-700 ml-9 mb-6">
          ...
          <li class="mb-10" data-aos="zoom-in">
            ...
            <p class="mb-4 text-base font-normal  text-gray-400">
              Bachlor's degree at San Jose State University.
            </p>
          ...
          <li class="mb-10" data-aos="zoom-out" data-aos-delay="700">
            ...
            <p class="text-base font-normal text-gray-400">
              <span class="block">•Designed a blog posting system with REST apis, ensuring the scalability and efficient resource utilization using Springboot framework. </span>
              <span class="block">•Optimized SQL queries in MySQL for efficient data management and query execution, resulting in a 13% improvement in query performance and response times.</span>
              <span class="block">•Utilized Docker and GitHub Actions to conduct Continuous Integration & Continuous Delivery(CI/CD), enhanced the efficiency of testing and version releases.</span>
              <span class="block">•Deployed the dockerized application on Digital Ocean, ensuring reliable performance and scalability, with 93% uptime and the elasticity to handle high-traffic loads.</span>
