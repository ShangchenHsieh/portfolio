                ...
                {socialLinks.map((social, index) => {
                  ...
                  return (
                    <button
                      ...
                      className={`p-4 bg-zinc-800/50 border border-zinc-700 rounded-full transition-all duration-300 hover:scale-110 hover:border-blue-500/50 ${social.color} group`}
                      title={social.label}
                    >
